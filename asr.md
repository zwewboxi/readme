...
| **GLM-ASR-Nano-2512** | **1.5B** | 智谱 | √ | mit |     |除标准普通话和英语外，模型针对粤语及其他方言进行了深度优化 |      |      |开源端侧模型，在多项基准测试中超越Whisper v3，专门优化了低音量语音和方言识别。 |
...
| **Kimi-Audio** | 7B | Moonshot AI | √ | MIT License | √ | 支持多语言 |  |   | 该模型基于并修改自Qwen 2.5-7B。源自Qwen2.5-7B的代码根据Apache 2.0许可证获得许可。代码的其他部分根据MIT许可证获得许可。 |
| **Step-Audio 2 mini** | 7B | StepFun | √ | Apache License 2.0 | √ | 支持多语言，明确涵盖中文（含多种方言）、英语。也支持日语、德语等 |      |      | 一个端到端的多模态大型语言模型，专为工业级音频理解和语音对话设计 |
| **seamless-m4t-large-v2** | **2.3B** | Meta | √ | cc-by-nc-4.0 | ✕ | 支持近100种语言的语音和文本互译 |     |     | 多任务统一模型，专注于多语言语音翻译与识别。 |
| **dolphin-small** | **372M** | Dataocean AI | √ | Apache License 2.0 |   | 支持东亚、南亚、东南亚和中东地区的 40 种东方语言，同时也支持 22 种中国方言 |     |     | 可以执行语音识别、语音活动检测（VAD）、分段和语言识别（LID） |
