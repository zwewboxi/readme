...
- **线性投影**：每个14×14×3的Patch通过可学习投影矩阵 Wp ∈ ℝ^(14×14×3)×D 映射为D维向量
  - 输入Patch张量形状：`(59,630, 14, 14, 3)` 展开为 `(59,630, 588)`
  - 投影计算：Z₀ = Flatten(Patches) · Wp ⇒ 输出形状 `(59,630, D)`
